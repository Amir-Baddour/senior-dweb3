document.addEventListener("DOMContentLoaded", function () {
  ...
  axios.get(`${API_BASE_URL}/get_profile.php`, axiosConfig) // ✅ replaced localhost
    .then(response => {
  ...
  document.getElementById("profileForm").addEventListener("submit", function (e) {
    ...
    axios.post(`${API_BASE_URL}/update_profile.php`, formData, axiosConfig) // ✅ replaced localhost
      .then(response => {
        if (response.data.success) {
